...
#   -------------------------------
#   12. JOB: NUACE PS services svc
#   -------------------------------
	
	alias gotoSvcRepo='cd /c/Developer/SVC-Projects/SVC/dev/'
	
	alias gradleCa='gotoSvcRepo && ./gradlew clean assemble && cd -'
	alias runSvc='gotoSvcRepo && ./gradlew jRun && cd -'
	alias debugSvc='gotoSvcRepoo && ./gradlew jRunDebug && cd -'
	
	
	#Configuration
	export SVC_CONFIG='/c/Developer/SVC-Projects/SVC/dev/config/montreal-lab'
	
	#export CRC_CONFIG='/c/Developer/SVC-Projects/SVC/dev/config/montreal-lab-crc'
